      ...
      <section className="team-members-wrapper">
        <div className="team-members-container">
          <div className="team-header-section">
            <p className="team-section-label">Members</p>
            <h2 className="team-main-heading">Introduce your team</h2>
            <p className="team-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
          </div>
                ...
                <div className="team-member-image-container">
                  {member.hasImage ? (
                    ...
                    <div className="team-placeholder-image">
                      <svg className="team-placeholder-icon" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="team-member-info">
                  ...
                  <div className="team-social-links">
                    <a href="#" className="team-social-link">
                      <svg className="team-social-icon" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="partnerships-container">
          <div className="partnerships-content">
            <div className="partnerships-text">
              <h2 className="partnerships-heading">Highlight key partnerships</h2>
